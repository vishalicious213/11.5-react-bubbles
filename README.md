...
Two steps that we learned about to secure data are using web tokens to provide proof of authentication to a website and using protected routes to safeguard content from public access.
